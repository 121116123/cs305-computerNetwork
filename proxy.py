    ...
    try:
        ...
        if test_case == 5:
            ...
            if len(test_buffer_pool[connection_key]) > bottle_neck:
                print(f"Buffer limit reached for {connection_key}, packet dropped")
                pass
                ...
                print(f"Sent packet for test case 5 to {addr}")
                ...
                print(f"Removed packet from buffer for {connection_key}")
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=30) as executor:
        while True:
            try:
                ...
                print("Packet received, submitting to case_test")
...
def result():
    ...
    while True:
        ...
        try:
            ...
            print(f"Sent result for {key[0]} test case {key[1]}: {response}")
        except Exception as e:
            print(e)
        finally:
            client_sock.close()
